...
interface ContentBlock {
    id: string; // Tạm thời để quản lý state trên UI
...
export default function CreateMultimediaLessonPage() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (!lessonRes.ok) throw new Error("Lỗi khi tạo Bài học");
            ...
            for (let i = 0; i < blocks.length; i++) {
                ...
                await fetchWithAuth(`${API_BASE_URL}/dynamic-admin/lesson-contents`, {
                    ...
                    body: JSON.stringify({
                        ...
                        thu_tu: i + 1 // Cập nhật thứ tự hiển thị
                    })
                });
            }
            ...
            <div className="flex items-center justify-between bg-card p-4 rounded-[2rem] border border-border/60 shadow-sm">
                ...
                <div className="flex items-center gap-4">
                    <div className="text-right hidden sm:block">
                        ...
                        <p className="text-xs font-medium text-foreground">Chương ID: {sectionId}</p>
                    </div>
                    <button 
                        onClick={handleSave}
                        disabled={isSaving}
